...
msg_btn = Button(window, text='Click to React', bg='blue', fg='black', width=20, command=show_message)
msg_btn.pack(pady=5)
...
def show_details():
    ...
    place.pack()
    top.mainloop()
details_btn = Button(window, text='See Details', bg='green', fg='black', width=20, command=show_details)
