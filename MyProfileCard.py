...
name_label = Label(window, text='Name', fg='white', bg='purple', width=25)
name_label.grid(row=1, column=0, padx=10, pady=10)
hobby_label = Label(window, text='Hobby', fg='white', bg='purple', width=25)
